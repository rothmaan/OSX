...
servers = [
    {
        :name => "master.rothman.io",
        :type => "master",
        :box => "ubuntu/xenial64",
        :box_version => "20181129.0.0",
        :eth0 => "10.0.15.15",
        :mem => "1500",
        :cpu => "2"
    },
    {
        :name => "node-1.rothman.io",
        :type => "node",
        :box => "ubuntu/xenial64",
        :box_version => "20181129.0.0",
        :eth0 => "10.0.15.16",
...
$configureNode = <<-SCRIPT
    ...
    sshpass -p "vagrant" scp -o StrictHostKeyChecking=no vagrant@10.0.15.15:/etc/kubeadm_join_cmd.sh .
